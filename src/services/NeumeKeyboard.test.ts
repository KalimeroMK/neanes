...
describe('NeumeKeyboard', () => {
  it('should have a mapping for every neume that is not in the list of exceptions', () => {
    const exceptions: Neume[] = [
      ...
      Note.PaLow,
      Note.ZoLow,
      VocalExpressionNeume.Piasma,
      VocalExpressionNeume.Lygisma,
      VocalExpressionNeume.Paraklitiki,
      VocalExpressionNeume.Tromikon,
      VocalExpressionNeume.Ekstrepton,
      VocalExpressionNeume.Isaki,
      VocalExpressionNeume.Naos,
